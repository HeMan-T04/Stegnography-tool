...
def create_card(url, title,align):
    c1='''
...
if __name__ == "__main__":
    ...
    with col1:
        st.write(create_card('''https://firebasestorage.googleapis.com/v0/b/stegproject-99219.appspot.com/o/imagesteg.png?alt=media&token=17510005-2b8c-4a08-aa1d-7c1b0b14e44f''','''Image Steganography''','''right'''),unsafe_allow_html=True)
    with col2:
        st.write(create_card('''https://firebasestorage.googleapis.com/v0/b/stegproject-99219.appspot.com/o/Audio_steg.png?alt=media&token=e2abfc52-3a94-4348-969c-3227850db7fb''','''Audio Steganography''','''left'''),unsafe_allow_html=True)
    col3,col4 = st.columns(2)
    with col3:
        st.write(create_card('''https://firebasestorage.googleapis.com/v0/b/stegproject-99219.appspot.com/o/videosteg.png?alt=media&token=7a21c4ad-cb8e-41bf-96e9-9ef39127085b''','''Video Steganography''','''right'''),unsafe_allow_html=True)
    with col4:
        st.write(create_card('''https://firebasestorage.googleapis.com/v0/b/stegproject-99219.appspot.com/o/textsteg.png?alt=media&token=3561afd0-7ef0-4a5c-ac0a-3b0011961018''','''Text Steganography''','''left'''),unsafe_allow_html=True)
